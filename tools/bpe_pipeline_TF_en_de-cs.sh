...
NAME="run_TF_en_de-cs"
OUT="temp/$NAME"

DATA=${TF}"/data/en_de-cs"
TRAIN_SRC=$DATA/train.en
TRAIN_TGT=$DATA/train.de-cs
TEST_SRC=$DATA/test.en
TEST_TGT=$DATA/test.de-cs
VALID_SRC=$DATA/dev.en
VALID_TGT=$DATA/dev.de-cs
...
bash tools/bpe_translate_O2M.sh en de cs Transformer TF