...
NAME="run_TF_en_de-tr"
OUT="temp/$NAME"

DATA=${TF}"/data/en_de-tr"
TRAIN_SRC=$DATA/train.en
TRAIN_TGT=$DATA/train.de-tr
TEST_SRC=$DATA/test.en
TEST_TGT=$DATA/test.de-tr
VALID_SRC=$DATA/dev.en
VALID_TGT=$DATA/dev.de-tr
...
bash tools/bpe_translate_O2M.sh en de tr Transformer TF